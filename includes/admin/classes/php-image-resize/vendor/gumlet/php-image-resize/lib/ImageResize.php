...
class ImageResize
{
     ...
     * @return static
     */
    public function save($filename, $image_type = null, $quality = null, $permissions = null, $exact_size = false, $tmp_file = false)
    {
        ...
        case IMAGETYPE_GIF:
            ...
            imagegif($dest_image, $custom_img);
            break;
        ...
        case IMAGETYPE_JPEG:
            ...
            imagejpeg($dest_image, $custom_img, $quality);
            break;
        ...
        case IMAGETYPE_WEBP:
            ...
            imagewebp($dest_image, $custom_img, $quality);
            break;
        ...
        case IMAGETYPE_PNG:
            ...
            imagepng($dest_image, $custom_img, $quality);
            break;
        }
        ...
        if ($permissions) {
            chmod($custom_img, $permissions);
        }

        imagedestroy($dest_image);

        $d = [
            'origin_img_size'    => filesize( $filename ),
            'tmp_img_size'       => filesize( $tmp_file )
        ];

        if( $d['origin_img_size'] > $d['tmp_img_size'] ) {
