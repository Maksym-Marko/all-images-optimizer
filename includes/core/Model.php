...
class MXAIO_Model
{
	...
	* Table name
	*/
	protected $table = MXAIO_TABLE_SLUG;
	...
	*/
	public function mxaio_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxaio_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
